...
public class DriveToTrackedTargetCommand extends CommandBase {
  ...
  */
  public DriveToTrackedTargetCommand(double distanceToTarget) {
    ...
    m_visionSubsystem = RobotContainer.visionSubsystem;
    desiredDistanceToTarget = distanceToTarget;
    addRequirements(drivetrainSubsystem, m_visionSubsystem);
  }
  ...
  */
  ...
  public void execute() {
    if (m_visionSubsystem.getHasTarget()) {
      ...
      if (trackedTarget != null) { // If a valid target has been retrieved
        ...
        drivetrainSubsystem.drive(leftDriveRate, rightDriveRate); // Finnally drive with the values we have
  ...
  public void end(boolean interrupted) {
    drivetrainSubsystem.stop(); // Stop the drivetrain motors
  }
