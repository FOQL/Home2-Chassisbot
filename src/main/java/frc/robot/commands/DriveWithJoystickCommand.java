...
import frc.robot.OperaterInput;
...
public class DriveWithJoystickCommand extends CommandBase {
  ...
  @Override
  public void execute() {
    double forwardSpeed = OperaterInput.driverJoystick.getLeftY();
    double turningSpeed = OperaterInput.driverJoystick.getRightX();
    drivetrainSubsystem.driveWithJoystick(filter.calculate(forwardSpeed), turningSpeed);
